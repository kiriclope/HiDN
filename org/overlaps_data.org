...
def overlaps_scorer(estimator, X_test, y_test, IF_SIGN=0):
    try:
        ...
        intercept = estimator.named_steps["model"].intercept_[0]  # Intercept is typically a 1-element array
        clf = estimator
    except:
    ...
    if IF_SIGN:
        dot_product = (2*y_test - 1) * (np.dot(X_test, coef) + intercept) / norm_w
    else:
        dot_product = (np.dot(X_test, coef) + intercept) / norm_w
...
#+begin_src ipython
  ...
  dum = 'overlaps_loocv_l1_sub_last'
#+end_src
...
<src.torch.stratified_subsample_kfold.ChoiceLimitedStratifiedKFold object at 0x7f2cd0c2f610>
Computing cv scores ...
Elapsed (with compilation) = 0h 2m 51s
coefs (122, 58296)
...
df (192, 18)
Elapsed (with compilation) = 0h 3m 42s
Loading files from /storage/leon/dual_task/data/JawsM15
X_days (1152, 693, 84) y_days (1152, 15)
...
<src.torch.stratified_subsample_kfold.ChoiceLimitedStratifiedKFold object at 0x7f2cd0c2f610>
Computing cv scores ...
Elapsed (with compilation) = 0h 5m 12s
coefs (322, 58296)
probas (322, 1, 84, 84, 2)
df_A (322, 18) scores (322, 7056) labels (322, 16)
scores_B (62, 84, 84)
df_B (62, 17) scores (62, 7056) labels (62, 16)
df (384, 18)
Elapsed (with compilation) = 0h 6m 2s
Loading files from /storage/leon/dual_task/data/JawsM18
X_days (1152, 444, 84) y_days (1152, 15)
DATA: FEATURES sample TASK all TRIALS incorrect DAYS first LASER 0
X_B (45, 444, 84) y_B (45,) [0. 1.] ['DPA' 'DualNoGo' 'DualGo']
DATA: FEATURES sample TASK all TRIALS correct DAYS first LASER 0
...
<src.torch.stratified_subsample_kfold.ChoiceLimitedStratifiedKFold object at 0x7f2cd0c2f610>
Computing cv scores ...
Elapsed (with compilation) = 0h 2m 34s
coefs (147, 37380)
probas (147, 1, 84, 84, 2)
df_A (147, 18) scores (147, 7056) labels (147, 16)
scores_B (45, 84, 84)
df_B (45, 17) scores (45, 7056) labels (45, 16)
df (192, 18)
Elapsed (with compilation) = 0h 3m 22s
Loading files from /storage/leon/dual_task/data/JawsM18
X_days (1152, 444, 84) y_days (1152, 15)
DATA: FEATURES sample TASK all TRIALS incorrect DAYS last LASER 0
X_B (13, 444, 84) y_B (13,) [0. 1.] ['DualNoGo' 'DualGo' 'DPA']
DATA: FEATURES sample TASK all TRIALS correct DAYS last LASER 0
...
coefs (371, 37380)
probas (371, 1, 84, 84, 2)
df_A (371, 18) scores (371, 7056) labels (371, 16)
scores_B (13, 84, 84)
df_B (13, 17) scores (13, 7056) labels (13, 16)
df (384, 18)
Elapsed (with compilation) = 0h 5m 24s
Loading files from /storage/leon/dual_task/data/ChRM04
X_days (1152, 668, 84) y_days (1152, 15)
DATA: FEATURES sample TASK all TRIALS incorrect DAYS first LASER 0
X_B (43, 668, 84) y_B (43,) [0. 1.] ['DPA' 'DualNoGo' 'DualGo']
DATA: FEATURES sample TASK all TRIALS correct DAYS first LASER 0
...
Elapsed (with compilation) = 0h 3m 22s
coefs (149, 56196)
probas (149, 1, 84, 84, 2)
df_A (149, 18) scores (149, 7056) labels (149, 16)
scores_B (43, 84, 84)
df_B (43, 17) scores (43, 7056) labels (43, 16)
df (192, 18)
Elapsed (with compilation) = 0h 4m 16s
Loading files from /storage/leon/dual_task/data/ChRM04
X_days (1152, 668, 84) y_days (1152, 15)
DATA: FEATURES sample TASK all TRIALS incorrect DAYS last LASER 0
X_B (35, 668, 84) y_B (35,) [0. 1.] ['DualGo' 'DPA' 'DualNoGo']
DATA: FEATURES sample TASK all TRIALS correct DAYS last LASER 0
...
<src.torch.stratified_subsample_kfold.ChoiceLimitedStratifiedKFold object at 0x7f2cd0c2f610>
Computing cv scores ...
Elapsed (with compilation) = 0h 6m 13s
coefs (349, 56196)
probas (349, 1, 84, 84, 2)
df_A (349, 18) scores (349, 7056) labels (349, 16)
scores_B (35, 84, 84)
df_B (35, 17) scores (35, 7056) labels (35, 16)
df (384, 18)
Elapsed (with compilation) = 0h 7m 36s
Loading files from /storage/leon/dual_task/data/ChRM23
X_days (960, 232, 84) y_days (960, 14)
DATA: FEATURES sample TASK all TRIALS incorrect DAYS first LASER 0
X_B (62, 232, 84) y_B (62,) [0. 1.] ['DPA' 'DualGo' 'DualNoGo']
DATA: FEATURES sample TASK all TRIALS correct DAYS first LASER 0
...
<src.torch.stratified_subsample_kfold.ChoiceLimitedStratifiedKFold object at 0x7f2cd0c2f610>
Computing cv scores ...
Elapsed (with compilation) = 0h 2m 48s
coefs (130, 19572)
probas (130, 1, 84, 84, 2)
df_A (130, 17) scores (130, 7056) labels (130, 15)
scores_B (62, 84, 84)
df_B (62, 16) scores (62, 7056) labels (62, 15)
df (192, 17)
Elapsed (with compilation) = 0h 4m 2s
Loading files from /storage/leon/dual_task/data/ChRM23
X_days (960, 232, 84) y_days (960, 14)
DATA: FEATURES sample TASK all TRIALS incorrect DAYS last LASER 0
X_B (75, 232, 84) y_B (75,) [0. 1.] ['DualNoGo' 'DPA' 'DualGo']
DATA: FEATURES sample TASK all TRIALS correct DAYS last LASER 0
...
#+RESULTS:
: a4f1f8b4-4742-44d2-9971-8f8b890a1fcd
...
#+RESULTS:
#+begin_example
Elapsed (with compilation) = 0h 5m 2s
coefs (576, 30408)
scores (576, 84, 84) 10.2975886379325
...
DATA: FEATURES test TASK all TRIALS all DAYS first LASER 0
y_labels (384, 16) ['DualNoGo' 'DPA' 'DualGo'] (384,)
X (384, 113, 84) nans 0.0 y (384,) [0. 1.]
(384, 113) (384,)
Fitting hyperparameters on single epoch ...
Elapsed (with compilation) = 0h 0m 33s
{'model__C': 0.4641588833612777}
<src.torch.stratified_subsample_kfold.ChoiceLimitedStratifiedKFold object at 0x7f2a922dd150>
Computing cv scores ...
Elapsed (with compilation) = 0h 1m 9s
coefs (384, 9576)
scores (384, 84, 84) -1.0490838767547495
...
Loading files from /storage/leon/dual_task/data/ACCM04
X_days (960, 113, 84) y_days (960, 15)
DATA: FEATURES test TASK all TRIALS all DAYS last LASER 0
...
coefs (576, 9576)
scores (576, 84, 84) -5.084885785713807
probas (576, 1, 84, 84, 2)
df_A (576, 18) scores (576, 7056) labels (576, 16)
df (576, 18)
Elapsed (with compilation) = 0h 2m 51s
...
#+RESULTS:
: saving to /storage/leon/dual_task/data/mice/overlaps/df_test_overlaps_loocv_l1_sub_last_early_late.pkl
...
{'model__C': 215.44346900318823}
<src.torch.stratified_subsample_kfold.ChoiceLimitedStratifiedKFold object at 0x7f2a92a6bad0>
Computing cv scores ...
Elapsed (with compilation) = 0h 0m 43s
coefs (192, 15540)
scores (192, 84, 84) -2.7342086360412567
...
coefs (192, 15540)
scores (192, 84, 84) -3.497037409572775
probas (192, 1, 84, 84, 2)
df_A (192, 17) scores (192, 7056) labels (192, 15)
df (192, 17)
...
coefs (192, 16968)
scores (192, 84, 84) 1.945680730403073
probas (192, 1, 84, 84, 2)
df_A (192, 17) scores (192, 7056) labels (192, 15)
df (192, 17)
Elapsed (with compilation) = 0h 2m 5s
Loading files from /storage/leon/dual_task/data/JawsM06
X_days (1152, 201, 84) y_days (1152, 14)
DATA: FEATURES choice TASK all TRIALS all DAYS last LASER 0
...
Elapsed (with compilation) = 0h 2m 5s
coefs (384, 16968)
scores (384, 84, 84) 1.699293980170738
probas (384, 1, 84, 84, 2)
...
coefs (192, 35616)
scores (192, 84, 84) 4.304149053677796
probas (192, 1, 84, 84, 2)
df_A (192, 17) scores (192, 7056) labels (192, 15)
df (192, 17)
Elapsed (with compilation) = 0h 2m 27s
Loading files from /storage/leon/dual_task/data/JawsM12
X_days (960, 423, 84) y_days (960, 14)
DATA: FEATURES choice TASK all TRIALS all DAYS last LASER 0
...
coefs (288, 35616)
scores (288, 84, 84) -0.09378176486171981
probas (288, 1, 84, 84, 2)
df_A (288, 17) scores (288, 7056) labels (288, 15)
df (288, 17)
Elapsed (with compilation) = 0h 3m 24s
Loading files from /storage/leon/dual_task/data/JawsM15
X_days (1152, 693, 84) y_days (1152, 15)
DATA: FEATURES choice TASK all TRIALS all DAYS first LASER 0
...
coefs (192, 58296)
scores (192, 84, 84) 14.499059098140508
probas (192, 1, 84, 84, 2)
...
<src.torch.stratified_subsample_kfold.ChoiceLimitedStratifiedKFold object at 0x7f2a92a6bad0>
Computing cv scores ...
Elapsed (with compilation) = 0h 4m 54s
coefs (384, 58296)
scores (384, 84, 84) 6.926601949890572
probas (384, 1, 84, 84, 2)
df_A (384, 18) scores (384, 7056) labels (384, 16)
df (384, 18)
Elapsed (with compilation) = 0h 5m 54s
Loading files from /storage/leon/dual_task/data/JawsM18
X_days (1152, 444, 84) y_days (1152, 15)
DATA: FEATURES choice TASK all TRIALS all DAYS first LASER 0
...
coefs (192, 37380)
scores (192, 84, 84) 17.782698339954855
probas (192, 1, 84, 84, 2)
df_A (192, 18) scores (192, 7056) labels (192, 16)
df (192, 18)
...
Elapsed (with compilation) = 0h 3m 22s
coefs (384, 37380)
scores (384, 84, 84) 14.684903205533963
probas (384, 1, 84, 84, 2)
df_A (384, 18) scores (384, 7056) labels (384, 16)
df (384, 18)
Elapsed (with compilation) = 0h 4m 19s
Loading files from /storage/leon/dual_task/data/ChRM04
X_days (1152, 668, 84) y_days (1152, 15)
DATA: FEATURES choice TASK all TRIALS all DAYS first LASER 0
...
coefs (192, 56196)
scores (192, 84, 84) 7.7471054507129935
probas (192, 1, 84, 84, 2)
df_A (192, 18) scores (192, 7056) labels (192, 16)
df (192, 18)
...
<src.torch.stratified_subsample_kfold.ChoiceLimitedStratifiedKFold object at 0x7f2a92a6bad0>
Computing cv scores ...
Elapsed (with compilation) = 0h 4m 56s
coefs (384, 56196)
scores (384, 84, 84) 11.946831286679483
probas (384, 1, 84, 84, 2)
df_A (384, 18) scores (384, 7056) labels (384, 16)
df (384, 18)
...
coefs (192, 19572)
scores (192, 84, 84) 0.2589114980266164
probas (192, 1, 84, 84, 2)
df_A (192, 17) scores (192, 7056) labels (192, 15)
df (192, 17)
...
<src.torch.stratified_subsample_kfold.ChoiceLimitedStratifiedKFold object at 0x7f2a92a6bad0>
Computing cv scores ...
Elapsed (with compilation) = 0h 1m 46s
coefs (288, 19572)
scores (288, 84, 84) 11.05368021751559
probas (288, 1, 84, 84, 2)
df_A (288, 17) scores (288, 7056) labels (288, 15)
df (288, 17)
Elapsed (with compilation) = 0h 2m 57s
...
<src.torch.stratified_subsample_kfold.ChoiceLimitedStratifiedKFold object at 0x7f2a92a6bad0>
Computing cv scores ...
Elapsed (with compilation) = 0h 3m 0s
coefs (384, 30408)
scores (384, 84, 84) 16.526051547289104
probas (384, 1, 84, 84, 2)
df_A (384, 18) scores (384, 7056) labels (384, 16)
df (384, 18)
...
coefs (576, 30408)
scores (576, 84, 84) -8.004820581043903
probas (576, 1, 84, 84, 2)
df_A (576, 18) scores (576, 7056) labels (576, 16)
df (576, 18)
Elapsed (with compilation) = 0h 6m 41s
Loading files from /storage/leon/dual_task/data/ACCM04
X_days (960, 113, 84) y_days (960, 15)
DATA: FEATURES choice TASK all TRIALS all DAYS first LASER 0
y_labels (384, 16) ['DualNoGo' 'DualGo' 'DPA'] (384,)
...
Elapsed (with compilation) = 0h 1m 45s
coefs (384, 9576)
scores (384, 84, 84) 3.8373035239726674
probas (384, 1, 84, 84, 2)
df_A (384, 18) scores (384, 7056) labels (384, 16)
df (384, 18)
Elapsed (with compilation) = 0h 2m 55s
Loading files from /storage/leon/dual_task/data/ACCM04
X_days (960, 113, 84) y_days (960, 15)
DATA: FEATURES choice TASK all TRIALS all DAYS last LASER 0
y_labels (576, 16) ['DPA' 'DualNoGo' 'DualGo'] (576,)
...
coefs (576, 9576)
scores (576, 84, 84) 4.855258369924965
probas (576, 1, 84, 84, 2)
df_A (576, 18) scores (576, 7056) labels (576, 16)
df (576, 18)
Elapsed (with compilation) = 0h 4m 8s
#+end_example
...
#+RESULTS:
: saving to /storage/leon/dual_task/data/mice/overlaps/df_choice_overlaps_loocv_l1_sub_last_early_late.pkl
...
#+begin_src ipython
options['features'] = 'test'
df_test = load_data('test', dum, **options)
df_test = get_avg_overlaps(df_test,  ['ED', 'LD', 'TEST', 'CHOICE', 'DELAY'], **options)
#+end_src

#+RESULTS:
: loading from /storage/leon/dual_task/data/mice/overlaps/df_test_overlaps_loocv_l1_sub_last_early_late.pkl

#+begin_src ipython
try:
    df_test['learning'] = df_test['day'].apply(lambda x: 'Naive' if x<=3 else 'Expert')
except:
    df_test['learning'] = df_test['day'].apply(lambda x: 'Naive' if x=='first' else 'Expert')

print(df_test.learning.unique())
#+end_src
...
for task in tasks:
    ...
    for learning, label, ls in [('Naive', 'Naive', '--'), ('Expert', 'Expert', '-')]:
        df_ = df[(df.learning == learning) & (df.pair==0)]
...
df_ = df_sample[(df_sample.choice==1) & (df_sample.pair==0)]
...
df_ = df_sample[(df_sample.choice==0)] # & (df_sample.pair==0)]
...
for task in tasks:
    ...
    for learning, label, ls in [('Naive', 'Naive', '--'), ('Expert', 'Expert', '-')]:
        df_ = df[(df.learning == learning) & (df.pair==1)]

        plot_overlaps(
            df_, 'all', epoch, ax[task['ax_idx']],
            title='', y0=0.0, if_proba=1, colors=colors,
            label=label, ls=ls, cis=None)
...
plt.savefig(f'figures/cosyne26/test_overlaps_first_last_paired.svg', dpi=300)
plt.show()
#+end_src
...
df_ = df_choice.copy()# [(df_choice.choice==1) & (df_choice.pair==0)]
...
#+RESULTS:
[[file:./figures/overlaps/figure_49.png]]
