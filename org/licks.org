...
Date:                Fri, 10 Oct 2025   Deviance:                       3928.4
Time:                        11:56:58   Pearson chi2:                 3.65e+03
...
Number of observations: 2736	 Groups: {'mouse': 9.0}

Log-likelihood: -1428.164 	 AIC: 2870.327

Random effects:

              Name    Var    Std
mouse  (Intercept)  0.876  0.936
mouse          day  0.146  0.382

               IV1  IV2   Corr
mouse  (Intercept)  day -0.821

Fixed effects:

              Estimate  2.5_ci  97.5_ci     SE     OR  OR_2.5_ci  OR_97.5_ci  \
(Intercept)     -1.094  -1.751   -0.437  0.335  0.335      0.174       0.646
licks_LD        -0.118  -0.169   -0.067  0.026  0.889      0.845       0.936
day              0.671   0.408    0.934  0.134  1.957      1.504       2.546
licks_LD:day     0.017   0.002    0.031  0.008  1.017      1.002       1.032

               Prob  Prob_2.5_ci  Prob_97.5_ci  Z-stat  P-val  Sig
(Intercept)   0.251        0.148         0.393  -3.263  0.001   **
licks_LD      0.471        0.458         0.483  -4.517  0.000  ***
day           0.662        0.601         0.718   5.001  0.000  ***
licks_LD:day  0.504        0.500         0.508   2.189  0.029    *
#+end_example
...
def licks_raster_all(trial_type, trial_licks, stimulus_onsets=None, ax=None, color='k'):
    ...
    for trial_idx, licks_in_trial in enumerate(trial_licks):
        if trial_type.iloc[trial_idx]=='DPA':
            ax.vlines(licks_in_trial, trial_idx , trial_idx + 10, color=pal[0], lw=1)
        if trial_type.iloc[trial_idx]=='DualGo':
            ax.vlines(licks_in_trial, trial_idx , trial_idx + 10, color=pal[1], lw=1)
        if trial_type.iloc[trial_idx]=='DualNoGo':
            ax.vlines(licks_in_trial, trial_idx , trial_idx + 10, color=pal[2], lw=1)
...
:RESULTS:
: (576, 18)
[[file:./.ob-jupyter/3ed0ba80bad3225a883a86e50f26fc3993e7aabf.png]]
:END:
...
#+RESULTS:
[[file:./.ob-jupyter/0c87b9587f63301c5a904173b743320785d3fb1a.png]]
...
#+RESULTS:
[[file:./.ob-jupyter/1f88e031158634e528d9021a60b285adf587ae07.png]]
