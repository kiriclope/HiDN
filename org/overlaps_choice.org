...
def plot_overlaps(df, day, epoch, ax, title='', y0=0.5, size=84, if_proba=0):
    ...
    for i, task in enumerate(mean_overlaps.index):
        ax.plot(time_points, mean_overlaps[task], label=f"{task}", color=colors[i])
...
#+RESULTS:
#+begin_src ipython
print(df_choice.keys())
#+end_src

#+RESULTS:
: 9bcda25c-9077-49c0-adde-8c6bcae85efc
...
#+RESULTS:
: 262b7072-2e51-4bcf-ae46-c082a9e379ee
...
df_choice['pair'] = df_choice['response'].apply(lambda x: 0 if (('rej' in x) or ('fa' in x)) else 1)
 ...
 #+RESULTS:
 : 173ad30b-64cb-4a86-889e-f584cfed12bf
...
#+RESULTS:
: a936ed2f-11db-4028-ab4d-6ddb5508836f
...
#+RESULTS:
: 35d3cace-8cb1-43ed-b9fa-969b5a360f18
...
#+RESULTS:
: 71251563-0a67-4956-bc36-bb610c85391a
...
#+begin_src ipython
print(df_choice.mouse.unique(), df_choice.shape)
#+end_src

#+RESULTS:
: ['JawsM01' 'JawsM06' 'JawsM12' 'JawsM15' 'JawsM18' 'ChRM04' 'ChRM23'
:  'ACCM03' 'ACCM04'] (9216, 16)
...
plot_overlaps(df, 'last', epoch, ax[2], title='Choice', y0=0.)
