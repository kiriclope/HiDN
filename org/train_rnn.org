...
#+RESULTS:
[[./.ob-jupyter/cad568617879879dd783803d442d90967d9959e1.png]]
...
#+RESULTS:
: torch.Size([288, 69, 693]) torch.Size([288, 69, 693])
...
#+RESULTS:
: X_train shape: torch.Size([230, 69, 693]) Y_train shape: torch.Size([230, 69, 693])
: X_test shape: torch.Size([58, 69, 693]) Y_test shape: torch.Size([58, 69, 693])
...
#+RESULTS:
#+begin_example
Epoch 0/100, Training Loss: 0.0019, Validation Loss: 0.0018
Epoch 10/100, Training Loss: 0.0018, Validation Loss: 0.0018
Epoch 20/100, Training Loss: 0.0019, Validation Loss: 0.0018
Epoch 30/100, Training Loss: 0.0018, Validation Loss: 0.0018
Epoch 40/100, Training Loss: 0.0019, Validation Loss: 0.0018
Epoch 50/100, Training Loss: 0.0016, Validation Loss: 0.0018
Epoch 60/100, Training Loss: 0.0018, Validation Loss: 0.0018
Epoch 70/100, Training Loss: 0.0018, Validation Loss: 0.0018
Epoch 80/100, Training Loss: 0.0016, Validation Loss: 0.0018
Epoch 90/100, Training Loss: 0.0017, Validation Loss: 0.0018
#+end_example

#+begin_src ipython
plt.hist(model.GAIN[0].cpu().detach(), bins='auto')
plt.xlabel('Gain')
plt.ylabel('Count')
plt.show()
#+end_src
...
: Cell In[428], line 1
: ----> 1 plt.hist(model.GAIN[0].cpu().detach(), bins='auto')
:       2 plt.xlabel('Gain')
:       3 plt.ylabel('Count')
:
...
#+RESULTS:
[[./.ob-jupyter/31e5b1f7cf5a59fc223ab1eda856c676a2e26827.png]]
...
#+RESULTS:
[[./.ob-jupyter/0afe7be70f3a21886620ff3897968beb60bd998b.png]]
...
#+RESULTS:
[[./.ob-jupyter/351e615e44b52f391e60854d02c111c552dbb329.png]]
...
#+RESULTS:
[[./.ob-jupyter/0b8e6dc676c0110fe9de226595e73b3d759dd791.png]]
...
#+RESULTS:
: array([-85.61268 +28.330336j  , -85.61268 -28.330336j  ,
:        -50.2674   +1.9438434j , -50.2674   -1.9438434j ,
:        -29.52582 +19.599636j  , -29.52582 -19.599636j  ,
:        -23.456383+15.015668j  , -23.456383-15.015668j  ,
:        -29.368193 +0.69631594j, -29.368193 -0.69631594j], dtype=complex64)
...
#+RESULTS:
[[./.ob-jupyter/c55406b7fb3a8087f0e3375d4ed61cd7572e59db.png]]
...
#+RESULTS:
: [4.9770627 4.9770627 5.410977  5.410977  5.4793367 5.4793367 5.770219
:  5.770219  7.0945845 7.0945845 7.698562 ]
...
#+RESULTS:
[[./.ob-jupyter/88ba527dea2614ffe17e4a99467361fa6553bf93.png]]
...
#+RESULTS:
[[./.ob-jupyter/80b93208891c3602eb9321016ed9cbe0444423c6.png]]
