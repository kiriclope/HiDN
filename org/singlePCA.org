...
#+RESULTS:
: saving to ../data/pca/X_all_nan_mad.pkl
: saving to ../data/pca/y_all_nan_mad.pkl
...
#+RESULTS:
: loading from ../data/pca/X_all_nan_mad.pkl
: loading from ../data/pca/y_all_nan_mad.pkl
...
:       4 n_repeats = 1
:       5 n_comp = 10
: ----> 7 pca = PCA(n_components=n_comp, svd_solver='randomized')
:       8 # folds = RepeatedStratifiedKFold(n_splits=n_splits, n_repeats=n_repeats)
:       9 folds = LeaveOneOut()
:
...
#+RESULTS:
#+begin_example
JawsM01: 100% 91/91 [00:00<00:00, 199.10it/s]
JawsM06: 100% 248/248 [00:02<00:00, 88.31it/s]
JawsM12: 100% 141/141 [00:02<00:00, 49.92it/s]
JawsM15: 100% 249/249 [00:12<00:00, 20.35it/s]
JawsM18: 100% 283/283 [00:10<00:00, 27.42it/s]
ChRM04: 100% 264/264 [00:12<00:00, 20.44it/s]
ChRM23: 100% 145/145 [00:01<00:00, 118.86it/s]
ACCM03: 100% 349/349 [00:12<00:00, 27.62it/s]
ACCM04: 100% 283/283 [00:02<00:00, 121.67it/s]
#+end_example
...
#+RESULTS:
: (9216, 84, 10) (9216, 18) (10, 184) (248, 10)
...
#+RESULTS:
: saving to ../data/pca//single_traj_TEST.pkl
: saving to ../data/pca//single_labels_TEST.pkl
: saving to ../data/pca//single_weights_TEST.pkl
: saving to ../data/pca//single_evr_TEST.pkl
...
idx_correct =  (y_single.learning=='Expert') & (y_single.performance==1)
idx_mouse = True
if i_mouse !=-1:
...
for (mouse, odor, learning), g in df.groupby(["mouse", "sample_odor", "learning"], sort=False):
    ...
    mean_traj = T.mean(axis=0) / (np.linalg.norm(T, axis=0) + 1e-12)
...
g = sns.catplot(
    ...
    sharey=True, errorbar=None
)
g.set_titles("{col_name}")
g.set_axis_labels("Mouse", "Abs(mean traj)")
...
g = sns.FacetGrid(wide, col="pc", col_order=pc_names, height=3.2, aspect=1.0, sharex=True, sharey=False)
g.map_dataframe(
    sns.scatterplot,
    x="Naive", y="Expert",
...
g = sns.FacetGrid(wide, col="pc", col_order=pc_names, height=3.2, aspect=1.0, sharex=True, sharey=True)
g.map_dataframe(
    sns.scatterplot,
    x="Naive", y="Expert",
    hue="mouse", palette=palette,
...
#+RESULTS:
[[file:./figures/singlePCA/figure_54.png]]
...
#+RESULTS:
[[file:./figures/singlePCA/figure_68.png]]
