...
for mouse in options['mice']:
    ...
    for day in range(1, options['n_days']+1):
        ...
        std_ = np.nanstd(X[idx], 0, ddof=0, keepdims=1)
        std_floor = np.nanpercentile(std_, 25)
...
def cv_pca(
    ...
    if clean_mask_fn is None:
        m_clean = (y.laser == 0) & (y.performance == 1) & (y.learning=='Expert')
    else:
...
#+RESULTS:
#+begin_example
JawsM01: 100% 91/91 [00:00<00:00, 122.49it/s]
JawsM06: 100% 248/248 [00:05<00:00, 43.62it/s]
JawsM12: 100% 141/141 [00:04<00:00, 30.34it/s]
JawsM15: 100% 249/249 [00:21<00:00, 11.35it/s]
JawsM18: 100% 283/283 [00:17<00:00, 16.10it/s]
ChRM04: 100% 264/264 [00:22<00:00, 11.50it/s]
ChRM23: 100% 145/145 [00:02<00:00, 64.95it/s]
ACCM03: 100% 349/349 [00:21<00:00, 16.04it/s]
ACCM04: 100% 283/283 [00:04<00:00, 68.45it/s]
#+end_example
...
evr_stack = np.vstack(evr_list)
print(w_stack.shape, evr_stack.shape)
#+end_src
...
#+RESULTS:
: saving to ../data/pca//single_traj_POST_GNG.pkl
: saving to ../data/pca//single_labels_POST_GNG.pkl
: saving to ../data/pca//single_weights_POST_GNG.pkl
...
idx_correct =  (y_single.performance==1) & (y_single.learning=='Expert')
idx_mouse = True
if i_mouse !=-1:
...
#+RESULTS:
[[file:./figures/pca/figure_67.png]]
...
8   JawsM01          0.0   0.000000   0.031250  -1.196489   4.074500
11  JawsM01          1.0  -0.006944   0.052083  -1.888792   4.290127
10  JawsM01          1.0   0.000000  -0.031250  -0.537801   3.221227
9   JawsM01          0.0   0.041667   0.020833  -0.610991   2.110613
15  JawsM06          1.0  -0.027778   0.000000   0.146639   0.516135
...
#+RESULTS:
[[file:./figures/pca/figure_72.png]]
...
#+RESULTS:
[[file:./figures/pca/figure_73.png]]
...
#+RESULTS:
[[file:./figures/pca/figure_74.png]]
