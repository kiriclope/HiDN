#+STARTUP: fold
#+PROPERTY: header-args:ipython :results both :exports both :async yes :session pca :kernel torch :output-dir ./figures/pca :file (lc/org-babel-tangle-figure-filename)
...
idx = (y_all.learning == 'Expert') & (y_all.laser==0) & (y_all.performance==1) & ((y_all.tasks=='DPA') | (y_all.odr_perf==1))
...
#+RESULTS:
: 896a9ad8-b0fd-43d5-a8be-9ffa6d5af185
...
: Cell In[17], line 1
: ----> 1 print(w_all.shape, evr_all.shape)
:
: NameError: name 'w_all' is not defined
:END:
...
#+RESULTS:
: 373e02ff-2e47-49a3-8a8f-cc8f3ec7de3c
...
#+RESULTS:
: 2007fce5-a46c-42c0-bf81-7f1d82577972
...
#+RESULTS:
[[file:./figures/overlaps/figure_106.png]]
...
#+RESULTS:
[[file:./figures/overlaps/figure_107.png]]
...
#+RESULTS:
[[file:./figures/overlaps/figure_108.png]]
...
#+RESULTS:
[[file:./figures/overlaps/figure_109.png]]
...
#+RESULTS:
[[file:./figures/overlaps/figure_110.png]]
...
# 3. Interpolate to grid
xi, yi, ui, vi = create_field(x, y, u, v, grid_size=16, method='linear', z_lim=3)
...
#+RESULTS:
[[file:./figures/overlaps/figure_137.png]]
...
for mouse in options['mice']:
    ...
    for day in options['days']:
        ...
        X_pca, y_pca = bootstrap_avg_pca(X, y, 100, 5, epoch, scaler)
        y_pca['learning'] = day
    ...
    X_mouse.append(X_day)
    y_mouse.append(pd.concat(y_day))
...
#+RESULTS:
: e61d978f-2d1c-47e3-89d5-7c1885f54f50
