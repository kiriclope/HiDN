...
#+begin_src ipython
  def hyper_tune(model, epoch, params, scoring, **options):
      ...
      cv = 5
      cv = RepeatedStratifiedKFold(n_splits=cv, n_repeats=10)
      # Perform grid search
...
#+RESULTS:
:RESULTS:
: bootstrap: 100% 1000/1000 [00:18<00:00, 53.43it/s]
:
: bootstrap: 100% 1000/1000 [00:06<00:00, 154.39it/s]
:
:END:
...
#+RESULTS:
:RESULTS:
: [162.94736842105263, 253.89473684210526]
: [102.3157894736842, 189.4736842105263]
[[file:./.ob-jupyter/0b1b7c1c3f8f42677cc71447d6f84bc160bc8bca.png]]
:END:
...
#+RESULTS:
[[file:./.ob-jupyter/0a382bce36f5badfa165df11ede8a2b5c623253f.png]]
