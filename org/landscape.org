...
#+begin_src ipython
  ...
  for i, day in enumerate(days):
      plot_theta_energy(theta_day[i], energy_day[i], ci=ci_day[i],
                        window=.2, ax=ax, SMOOTH=0, color=colors[i])
...
#+RESULTS:
:RESULTS:
: [64.42105263157895, 197.05263157894737, 322.10526315789474]
: The distance between the two main minima is 47.368421052631575 degrees.
: [109.89473684210526, 238.73684210526315]
: The distance between the two main minima is 51.15789473684211 degrees.
[[file:./.ob-jupyter/264d96426ab1b2c153ada46a7f9629b07646d8ec.png]]
:END:
