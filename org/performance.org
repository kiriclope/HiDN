...
:        'odr_response', 'odr_choice', 'odr_perf', 'mouse', 'behavior',
:        'learning'],
:       dtype='object')
...
#+RESULTS:
[[file:./.ob-jupyter/5823cef0cf63f1dda7e9404728fdd22c2d23ed2f.png]]
...
pal = [palette2[3], palette[3]]

sns.lineplot(data=df, x='day', y='performance',  marker='o', markeredgecolor='none', hue='laser', palette=pal)
...
plt.yticks([0.5, 0.75, 1])
plt.legend(fontsize=12, frameon=0)
plt.savefig('figures/perf/dpa_perf_opto.svg', dpi=300)
plt.show()
#+end_src

#+RESULTS:
[[file:./.ob-jupyter/787ce08405ce85c09c3413bbe911454a5d8f771c.png]]

#+begin_src ipython
palette = sns.color_palette("muted")
palette2 = sns.color_palette("bright")
pal = [palette2[0], palette[0]]

sns.lineplot(data=df, x='day', y='odr_perf', marker='o', markeredgecolor='none', palette=pal, hue='laser')
...
plt.yticks([0.5, 0.75, 1])
plt.legend(fontsize=12, frameon=0)
plt.savefig('figures/perf/gng_perf_opto.svg', dpi=300)
plt.show()
#+end_src

#+RESULTS:
[[file:./.ob-jupyter/a8587bb6198ccc8a186e4ffaaadedb4b92758c24.png]]
...
df1 = df[df.tasks=='DualGo']
sns.lineplot(data=df1, x='day', y='odr_perf', legend=None,  marker='o', markeredgecolor='none', palette=pal, hue='laser')

pal = [palette2[2], palette[2]]
df2 = df[df.tasks=='DualNoGo']
sns.lineplot(data=df2, x='day', y='odr_perf', legend=None,  marker='o', markeredgecolor='none', palette=pal, hue='laser')
# sns.lineplot(data=df, x='day', y='odr_perf', legend=None,  marker='o', markeredgecolor='none', label='GNG', color=pal[1], hue='laser')
...
#+RESULTS:
:RESULTS:
: /home/leon/tmp/ipykernel_2549054/159373103.py:19: UserWarning: No artists with labels found to put in legend.  Note that artists whose label start with an underscore are ignored when legend() is called with no argument.
:   plt.legend(fontsize=12, frameon=0)
[[file:./.ob-jupyter/7a40ec9b6830022fd148baf0ddf739e3e2c7e59a.png]]
:END:
