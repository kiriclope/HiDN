...
#+RESULTS:
: saving to ../data/pca/X_all_mad_trial.pkl
: saving to ../data/pca/y_all_mad_trial.pkl
...
#+RESULTS:
: loading from ../data/pca/X_all_std_trial.pkl
: loading from ../data/pca/y_all_std_trial.pkl
...
#+RESULTS:
: cv_pca: 100% 50/50 [02:48<00:00,  3.38s/it]
...
#+RESULTS:
: saving to ../data/pca//meta_traj_POST_GNG_mad_trial_10.pkl
: saving to ../data/pca//meta_labels_POST_GNG_mad_trial_10.pkl
: saving to ../data/pca//meta_weights_POST_GNG_mad_trial_10.pkl
: saving to ../data/pca//meta_evr_POST_GNG_mad_trial_10.pkl
...
#+RESULTS:
: loading from ../data/pca//meta_traj_POST_GNG_mad_trial_10.pkl
: loading from ../data/pca//meta_labels_POST_GNG_mad_trial_10.pkl
: loading from ../data/pca//meta_weights_POST_GNG_mad_trial_10.pkl
: loading from ../data/pca//meta_evr_POST_GNG_mad_trial_10.pkl
...
plt.savefig('./figures/pca/pca_scatter_%s.svg' % dum)
...
plt.savefig('./figures/pca/pca_scatter_choice_%s.svg' % dum)
...
#+RESULTS:
[[file:./figures/pca/figure_56.png]]
...
: 8   JawsM01          0.0  -0.037338   0.033113  -0.105002  -0.449773
: 11  JawsM01          1.0  -0.006944   0.052083  -0.054280  -0.538898
: 10  JawsM01          1.0  -0.055877  -0.031250  -0.156585  -0.342518
: 9   JawsM01          0.0   0.041667   0.020833  -0.118249  -0.177985
: 15  JawsM06          1.0  -0.027778   0.000000   0.272665  -0.110189
...
#+RESULTS:
: 84961784-5c8b-42ed-8f15-5ed8da97f7cb
