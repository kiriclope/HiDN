        ...
        if SCALE is not None:
            for day in range(1, options_mouse["n_days"] + 1):
                ...
                if SCALE == 'std':
                    ...
                    # std_safe = np.where(std_ < 1e-4, 1, std_)
...
#+RESULTS:
: saving to ../data/pca/X_all_std.pkl
: saving to ../data/pca/y_all_std.pkl
...
#+RESULTS:
: loading from ../data/pca/X_all_std.pkl
: loading from ../data/pca/y_all_std.pkl
...
#+RESULTS:
: cv_pca: 100% 5/5 [05:02<00:00, 60.44s/it]
...
#+RESULTS:
: (9216, 84, 3) (9216, 18) (3, 3319) (3, 3319) (5, 3)
...
#+RESULTS:
[[file:./figures/pca/figure_27.png]]
...
#+RESULTS:
: saving to ../data/pca//meta_traj_TEST_std.pkl
: saving to ../data/pca//meta_labels_TEST_std.pkl
: saving to ../data/pca//meta_weights_TEST_std.pkl
: saving to ../data/pca//meta_evr_TEST_std.pkl
...
#+RESULTS:
: loading from ../data/pca//meta_traj_TEST_std.pkl
: loading from ../data/pca//meta_labels_TEST_std.pkl
: loading from ../data/pca//meta_weights_TEST_std.pkl
: loading from ../data/pca//meta_evr_TEST_std.pkl
...
idx_tasks = (y_meta.tasks == 'DPA') & (y_meta.learning=='Expert')
idx_correct =  (y_meta.performance==1) # & ( (y_meta.tasks == 'DPA') | (y_meta.odr_perf==1))
idx_mouse = True
if i_mouse !=-1:
...
#+begin_src jupyter-python
fp_mouse = np.nanmean(traj_mouse[..., options['bins_ED']], -1)
fp_opto = np.nanmean(traj_opto[..., options['bins_ED']], -1)
...
: 8   JawsM01          0.0   0.000000   0.031250  -0.052462  -0.032581
: 11  JawsM01          1.0  -0.006944   0.052083  -0.024329  -0.041578
: 10  JawsM01          1.0   0.000000  -0.031250   0.015256   0.011389
: 9   JawsM01          0.0   0.041667   0.020833   0.013286   0.079578
: 15  JawsM06          1.0  -0.027778   0.000000   0.017598   0.040960
...
#+RESULTS:
[[file:./figures/pca/figure_68.png]]
...
#+RESULTS:
[[file:./figures/pca/figure_69.png]]
