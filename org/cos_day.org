...
#+RESULTS:
[[file:./.ob-jupyter/606ca355ac1c4aab3166f0b09c783feb9ef4cd64.png]]
...
#+begin_src ipython
  plt.plot(days, np.mean(cos[1,...], 0).T)
  plt.show()
#+end_src

#+RESULTS:
[[file:./.ob-jupyter/bdda41447801461e964cf4b844765f46d458ce93.png]]
...
#+begin_src ipython
  ...
  cos = pkl.load(open("../figs/overlaps/cos_day.pkl", "rb"))
#+end_src
...
#+begin_src ipython
  ...
  for i in range(cos.shape[0]):
      plt.plot(days, np.mean(cos[i], 0), '-o', ms=5, alpha=.2)
...
#+RESULTS:
[[file:./.ob-jupyter/e7c108d063a8262a6e714ad7127c94dcb7cc7d3a.png]]
