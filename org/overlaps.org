...
#+begin_example
    ...
    X (55, 693, 84) y (55,)
  bootstrap: 100% 1000/1000 [00:02<00:00, 341.69it/s]
    Done
    loading files from /home/leon/dual_task/dual_data/data/JawsM15
    X_days (1152, 693, 84) y_days (1152, 6)
    ##########################################
    ...
    X (78, 693, 84) y (78,)
  bootstrap: 100% 1000/1000 [00:03<00:00, 290.76it/s]
    Done
#+end_example
[[file:./.ob-jupyter/e189e923e345756c59fe51d28ab9c81154f37c63.png]]
:END:
*** all mice
#+begin_src ipython :
  # mice = ['ChRM04', 'JawsM15', 'JawsM18', 'ACCM03', 'ACCM04']
...
#+begin_example
    ...
    X_S1 (33, 693, 84) X_S2 (37, 693, 84)
    X (70, 693, 84) y (70,)
  bootstrap: 100% 1000/1000 [00:03<00:00, 279.21it/s]
    Done
    loading files from /home/leon/dual_task/dual_data/data/JawsM15
    X_days (1152, 693, 84) y_days (1152, 6)
    ##########################################
    ...
    X_S1 (41, 693, 84) X_S2 (41, 693, 84)
    X (82, 693, 84) y (82,)
  bootstrap: 100% 1000/1000 [00:03<00:00, 252.69it/s]
    Done
#+end_example
[[file:./.ob-jupyter/d5f94e3a146b0df64a6b96a5a67b646ac814cab5.png]]
:END:
*** all mice
#+begin_src ipython
...
#+begin_example
  ...
  X (77, 668, 84) y (77,)
bootstrap: 100% 1000/1000 [00:03<00:00, 279.67it/s]
  Done
  loading files from /home/leon/dual_task/dual_data/data/ChRM04
  X_days (1152, 668, 84) y_days (1152, 6)
  ##########################################
  ...
  X (89, 668, 84) y (89,)
bootstrap: 100% 1000/1000 [00:03<00:00, 283.12it/s]
  Done
  ...
  X (78, 444, 84) y (78,)
bootstrap: 100% 1000/1000 [00:02<00:00, 370.97it/s]
  Done
  loading files from /home/leon/dual_task/dual_data/data/JawsM18
  X_days (1152, 444, 84) y_days (1152, 6)
  ##########################################
  ...
  X (94, 444, 84) y (94,)
bootstrap: 100% 1000/1000 [00:03<00:00, 328.51it/s]
  Done
  loading files from /home/leon/dual_task/dual_data/data/ACCM03
  X_days (960, 361, 84) y_days (960, 6)
  ##########################################
  ...
  X_S1 (44, 361, 84) X_S2 (38, 361, 84)
  X (82, 361, 84) y (82,)
bootstrap: 100% 1000/1000 [00:02<00:00, 370.57it/s]
  Done
  loading files from /home/leon/dual_task/dual_data/data/ACCM03
  X_days (960, 361, 84) y_days (960, 6)
  ##########################################
  ...
  X_S1 (70, 361, 84) X_S2 (64, 361, 84)
  X (134, 361, 84) y (134,)
bootstrap: 100% 1000/1000 [00:03<00:00, 300.00it/s]
  Done
  ...
  X (86, 113, 84) y (86,)
bootstrap: 100% 1000/1000 [00:02<00:00, 458.41it/s]
  Done
  loading files from /home/leon/dual_task/dual_data/data/ACCM04
  X_days (960, 113, 84) y_days (960, 6)
  ##########################################
  ...
  X (121, 113, 84) y (121,)
bootstrap: 100% 1000/1000 [00:02<00:00, 396.96it/s]
  Done
#+end_example
