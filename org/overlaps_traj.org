...
#+RESULTS:
: loading from /storage/leon/dual_task/data/mice/overlaps/df_sample_overlaps_loocv_sub_early_late.pkl
...
#+RESULTS:
: loading from /storage/leon/dual_task/data/mice/overlaps/df_choice_overlaps_loocv_sub_early_late.pkl
: loading from /storage/leon/dual_task/data/mice/overlaps/df_choice_overlaps_loocv_sub_0.5_early_late.pkl
...
#+RESULTS:
: loading from /storage/leon/dual_task/data/mice/overlaps/df_choice_overlaps_loocv_sub_laser_on_0.5_early_late.pkl
...
0  JawsM01  first          0.0     -0.097021    -0.156781       -0.059760
1  JawsM01  first          1.0     -0.023870    -0.219785       -0.195915
2  JawsM01   last          0.0     -0.020241    -0.180803       -0.160562
3  JawsM01   last          1.0     -0.068554    -0.242225       -0.173671
4  JawsM06  first          0.0     -0.031155    -0.191510       -0.160354

   perf_off   perf_on  odr_perf_off  odr_perf_on  delta_perf  delta_odr_perf
0  0.578125  0.734375       0.93750      0.93750    0.156250         0.00000
1  0.781250  0.796875       0.90625      0.93750    0.015625         0.03125
2  0.968750  0.929688       0.96875      0.90625   -0.039062        -0.06250
3  0.921875  0.914062       1.00000      0.93750   -0.007812        -0.06250
4  0.562500  0.609375       0.87500      0.75000    0.046875        -0.12500
#+end_example
