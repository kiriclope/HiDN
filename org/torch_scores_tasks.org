...
#+begin_src ipython :tangle ../src/torch/classificationCV.py
  ...
  class ClassificationCV():
      ...
      def get_cv_scores(self, X, y, scoring):
          ...
          estimator = SlidingEstimator(clone(self.best_model), n_jobs=16,
...
#+begin_example
  ...
  imbalance tensor(1.4615, device='cuda:0')
  X (32, 693, 84) y (32,)
  ...
  imbalance tensor(1.1333, device='cuda:0')
  X (32, 693, 84) y (32,)
  Elapsed (with compilation) = 0h 0m 30s
  Loading files from /home/leon/dual_task/dual_data/data/JawsM15
  PREPROCESSING: SCALER robust AVG MEAN False AVG NOISE True UNIT VAR False
  ...
  imbalance tensor(0.3913, device='cuda:0')
  X (32, 693, 84) y (32,)
  Elapsed (with compilation) = 0h 0m 32s
  Loading files from /home/leon/dual_task/dual_data/data/JawsM15
  PREPROCESSING: SCALER robust AVG MEAN False AVG NOISE True UNIT VAR False
  ...
  imbalance tensor(0.7778, device='cuda:0')
  X (32, 693, 84) y (32,)
  Elapsed (with compilation) = 0h 0m 29s
  Loading files from /home/leon/dual_task/dual_data/data/JawsM15
  PREPROCESSING: SCALER robust AVG MEAN False AVG NOISE True UNIT VAR False
  ...
  imbalance tensor(0.3333, device='cuda:0')
  X (32, 693, 84) y (32,)
  Elapsed (with compilation) = 0h 0m 30s
  Loading files from /home/leon/dual_task/dual_data/data/JawsM15
  PREPROCESSING: SCALER robust AVG MEAN False AVG NOISE True UNIT VAR False
  ...
  imbalance tensor(0.8824, device='cuda:0')
  X (32, 693, 84) y (32,)
  Elapsed (with compilation) = 0h 0m 30s
  (2, 2, 6, 3, 84)
  Loading files from /home/leon/dual_task/dual_data/data/JawsM15
  ...
  imbalance tensor(2.2000, device='cuda:0')
  X (32, 693, 84) y (32,)
  Elapsed (with compilation) = 0h 0m 31s
  Loading files from /home/leon/dual_task/dual_data/data/JawsM15
  PREPROCESSING: SCALER robust AVG MEAN False AVG NOISE True UNIT VAR False
  ...
  imbalance tensor(1.2857, device='cuda:0')
  X (32, 693, 84) y (32,)
  Elapsed (with compilation) = 0h 0m 30s
  Loading files from /home/leon/dual_task/dual_data/data/JawsM15
  PREPROCESSING: SCALER robust AVG MEAN False AVG NOISE True UNIT VAR False
  ...
  imbalance tensor(0.2800, device='cuda:0')
  X (32, 693, 84) y (32,)
  Elapsed (with compilation) = 0h 0m 30s
  Loading files from /home/leon/dual_task/dual_data/data/JawsM15
  PREPROCESSING: SCALER robust AVG MEAN False AVG NOISE True UNIT VAR False
...
#+RESULTS:
[[file:./.ob-jupyter/eec3c05fc69ec49d832962adeb3098fd8829fb02.png]]
...
#+RESULTS:
[[file:./.ob-jupyter/71f0fc96c880eac83f75dbd92c66994ea0e5cb2b.png]]
