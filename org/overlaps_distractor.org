...
if len(mice)==1:
    df_dist = pkl_load('%s' % name, path="../data/%s/overlaps" % mice[0])
elif len(mice)==2:
    df_dist = pkl_load('%s' % name, path="../data/mice/overlaps_ACC")
else:
    df_dist = pkl_load('%s' % name, path="../data/mice/overlaps")#.reset_index()
#+end_src

#+RESULTS:
: loading from ../data/mice/overlaps/df_dist_overlaps_loocv_early_late.pkl
...
#+begin_src ipython
options['T_WINDOW'] = 0.0
for epoch in ['DIST', 'DIST_MD', 'MD', 'CUE', 'RWD' ,'LD']:
...
Index(['index', 'sample_odor', 'dist_odor', 'test_odor', 'tasks', 'response',
       ...
       'overlaps_diag_CUE', 'overlaps_diag_RWD', 'overlaps_diag_LD',
       'overlaps_diag_TEST', 'overlaps_diag_DIST', 'overlaps_diag_RWD2',
       'overlaps_DIST_MD', 'overlaps_DIST_MD_ED', 'overlaps_DIST_MD_DIST',
       'overlaps_DIST_MD_MD', 'overlaps_DIST_MD_CUE', 'overlaps_DIST_MD_RWD',
       'overlaps_DIST_MD_LD', 'overlaps_MD', 'overlaps_MD_ED',
       'overlaps_MD_DIST', 'overlaps_MD_MD', 'overlaps_MD_CUE',
       'overlaps_MD_RWD', 'overlaps_MD_LD', 'overlaps_CUE', 'overlaps_CUE_ED',
       'overlaps_CUE_DIST', 'overlaps_CUE_MD', 'overlaps_CUE_CUE',
       'overlaps_CUE_RWD', 'overlaps_CUE_LD', 'overlaps_RWD',
       'overlaps_RWD_ED', 'overlaps_RWD_DIST', 'overlaps_RWD_MD',
       'overlaps_RWD_CUE', 'overlaps_RWD_RWD', 'overlaps_RWD_LD',
       'overlaps_LD', 'overlaps_LD_ED', 'overlaps_LD_DIST', 'overlaps_LD_MD',
       'overlaps_LD_CUE', 'overlaps_LD_RWD', 'overlaps_LD_LD'],
      dtype='object')
#+end_example
...
plot_overlaps(df[(df.pair==1)], 'first', epoch, ax[0], title='Sample', y0=0., ls='-', label='Lick', colors=['r'])
plot_overlaps(df[(df.pair==0)], 'first', epoch, ax[0], title='Sample', y0=0.,ls='--', label='No Lick', colors=['r'])

if n_>2:
     plot_overlaps(df[(df.pair==1)], 'middle', epoch, ax[1], title='Sample', y0=0., ls='-', label='Lick', colors=['r'])
     plot_overlaps(df[(df.pair==0)], 'middle', epoch, ax[1], title='Sample', y0=0., ls='--', label='No Lick', colors=['r'])

plot_overlaps(df[(df.pair==1)], 'last', epoch, ax[n_-1], title='Sample', y0=0., ls='-', label='Lick', colors=['r'])
plot_overlaps(df[(df.pair==0)], 'last', epoch, ax[n_-1], title='Sample', y0=0., ls='--', label='No Lick', colors=['r'])
...
# ax[2].legend(fontsize=10)
plt.savefig('figures/icrm/dist_overlaps_%s_dpa_licks.svg' % epoch, dpi=300)
...
plot_overlaps(df[(df.choice==1)], 'first', epoch, ax[0], title='Sample', y0=0., ls='-', label='Pair Trial', colors=['b'])
plot_overlaps(df[(df.choice==0)], 'first', epoch, ax[0], title='Sample', y0=0.,ls='--', label='No Pair Trial', colors=['b'])

if n_>2:
     plot_overlaps(df[(df.choice==1)], 'middle', epoch, ax[1], title='Sample', y0=0., ls='-', label='Pair Trial', colors=['b'])
     plot_overlaps(df[(df.choice==0)], 'middle', epoch, ax[1], title='Sample', y0=0., ls='--', label='No Pair Trial', colors=['b'])

plot_overlaps(df[(df.choice==1)], 'last', epoch, ax[n_-1], title='Sample', y0=0., ls='-', label='Pair Trial', colors=['b'])
plot_overlaps(df[(df.choice==0)], 'last', epoch, ax[n_-1], title='Sample', y0=0., ls='--', label='No Pair Trial', colors=['b'])
...
#+RESULTS:
[[./figures/dist_overlaps/figure_37.png]]
...
plot_overlaps(df[(df.pair==0)], 'first', epoch, ax[0], title='Sample', y0=0.,ls='--', label='Unpair Trial', colors=['g'])

if n_>2:
     plot_overlaps(df[(df.pair==1)], 'middle', epoch, ax[1], title='Sample', y0=0., ls='-', label='Pair Trial', colors=['g'])
     plot_overlaps(df[(df.pair==0)], 'middle', epoch, ax[1], title='Sample', y0=0., ls='--', label='Unpair Trial', colors=['g'])

plot_overlaps(df[(df.pair==1)], 'last', epoch, ax[n_-1], title='Sample', y0=0., ls='-', label='Pair Trial', colors=['g'])
plot_overlaps(df[(df.pair==0)], 'last', epoch, ax[n_-1], title='Sample', y0=0., ls='--', label='Unpair Trial', colors=['g'])
...
# ax[2].legend(fontsize=10)
plt.savefig('figures/icrm/dist_overlaps_%s_dualnogo_licks.svg' % epoch, dpi=300)
...
plot_overlaps(df[(df.pair==1)], 'first', epoch, ax[0], title='Sample', y0=0., ls='-', label='Lick', colors=['b'])
plot_overlaps(df[(df.pair==0)], 'first', epoch, ax[0], title='Sample', y0=0.,ls='--', label='No Lick', colors=['b'])

plot_overlaps(df[(df.pair==1)], 'middle', epoch, ax[1], title='Sample', y0=0., ls='-', label='Lick', colors=['b'])
plot_overlaps(df[(df.pair==0)], 'middle', epoch, ax[1], title='Sample', y0=0., ls='--', label='No Lick', colors=['b'])

plot_overlaps(df[(df.pair==1)], 'last', epoch, ax[2], title='Sample', y0=0., ls='-', label='Lick', colors=['b'])
plot_overlaps(df[(df.pair==0)], 'last', epoch, ax[2], title='Sample', y0=0., ls='--', label='No Lick', colors=['b'])
...
~/tmp/ipykernel_944958/2047170964.py in ?()
      2
      3 df = df_dist.copy()
      4 df = df[df.laser==0]
      5 # df = df[df.odr_perf==1]
----> 6 df = df[df.dist==0]
      7 # df = df[df.performance==0]
...
Cell In[36], line 10
      ...
      8 df = df[df.mouse!='ACCM04']
---> 10 plot_overlaps(df, 'first', '%s' % epoch, ax[0], title='Dist', y0=0.)
     12 df = df_dist.copy()
